...
class CalculatorIntegrationDivTest {
    ...
    void testDivideEndpoint() throws Exception {
        ...
        String leftField = "10";
        String rightField = "2";
        String typeDropDown = "DIVISION"; // Utilisation de la valeur du type DIVIDE
        ...
        assertThat(content).contains("<span id=\"solution\">5</span>");  // Vérifie que la solution est "8"
    }
}
